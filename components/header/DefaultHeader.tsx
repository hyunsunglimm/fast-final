          ...
          <AnimatePresence>
            {openDropdown && (
              <motion.div
                ...
                className='absolute right-0 z-50 mt-2 w-[8rem] origin-top-right rounded-md bg-white px-8 py-8 text-center shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none'
                role='menu'
