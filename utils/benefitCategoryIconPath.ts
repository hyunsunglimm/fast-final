export const benefitCategoryIconPath: { [key: string]: string } = {
  대중교통: '/icons/system-icon/system/card-bus.svg',
  식비: '/icons/system-icon/system/card-food.svg',
  카페: '/icons/system-icon/system/card-cafe.svg',
